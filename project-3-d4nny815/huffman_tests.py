...
class TestList(unittest.TestCase):
    ...
    #     else: # pragma: no cover
    #         self.fail()
    #     hufftree2 = create_huff_tree([0] * 256)
    ...
    #     self.assertEqual(create_code(None), [])
    ...
    def test_05_textfile(self) -> None:
        ...
        huffman_decode("single_out.txt", "single_decode.txt")
        self.assertTrue(compare_files("single.txt", "single_decode.txt"))
